 ...
 */
    ...
    *::after {
    ...
    .card-boxp img {
        /* max-width: 50px;
        max-height: 50px; */
        box-shadow:  0 0 32px 4px #d49204;
        /* backdrop-filter: blur( 8px );
        -webkit-backdrop-filter: blur( 8px ); */
        border-radius: 15px;
        /* border: 1px solid rgba( 255, 255, 255, 0.18 ) !important; */
    ...
    .sm{
       background: #151a21;
       padding-top: 10px;
       border-top: 2px solid #d49204;
       border-top-right-radius: 40px;
       border-top-left-radius: 40px;
       box-shadow:  0 0 32px 8px #d49204 ;
       color: #fff;

    }

    .aimg{
        box-shadow:  0 0 40px 24px #d49204 ;
        border-radius: 60px;
    ...
    /* background-section */
    .bg-scroll-light {
        background-color: #8303ee3d !important;
        border: 1px solid #9876dd;
    }
    ...
    <link rel="stylesheet" href="https://hamstercuan.com/assets/global/css/line-awesome.min.css">
    <link rel="stylesheet" href="https://hamstercuan.com/assets/templates/basic/css/lightcase.css">

    
    
    
    <link rel="stylesheet" href="https://hamstercuan.com/assets/templates/basic/css/color.php?color1=ffffff&color2=001d4a">
...
//<![CDATA[
window.__mirage2 = {petok:"MeuM0dImSkLSOJWi0noZpJ7rNtYZitw7VfR2KyP_deY-1800-0.0.1.1"};
//]]>
</script>
<script type="text/javascript" src="https://ajax.cloudflare.com/cdn-cgi/scripts/04b3eb47/cloudflare-static/mirage2.min.js"></script>
<img width="40px" class="loaderCustom" alt="" data-cfsrc="https://hamstercuan.com/assets/templates/basic/assets/img/loader/loading-gif.gif" style="display:none;visibility:hidden;"><noscript><img width="40px" class="loaderCustom" src="https://hamstercuan.com/assets/templates/basic/assets/img/loader/loading-gif.gif" alt=""></noscript>
    </div>
</div>
    ...
    <body class="body-scroll d-flex flex-column h-100 menu-overlay">
        ...
        <main class="flex-shrink-0 main has-footer mt-5">
    ...
    background-color: transparent !important;
            ...
            <header class="header">
                <div class="row">
                  <div class="col align-self-center text-center">
                    <a class="navbar-brand" href="https://hamstercuan.com">
                        <h5 class="mb-0">
                          <img height="30px" alt="site-logo" data-cfsrc="https://hamstercuan.com/assets/images/logoIcon/logologin.png" style="display:none;visibility:hidden;"><noscript><img height="30px" src="https://hamstercuan.com/assets/images/logoIcon/logologin.png" alt="site-logo"></noscript>
                        </h5>
                    </a>
                  </div>
                </div>
            ...
            <div class="main-container">
              <form id="loginForm" method="POST" action="https://hamstercuan.com/user/login" class="login-form mt-50 verify-gcaptcha">
                  <input type="hidden" name="_token" value="5KzN86WQ3faks18KjTsRLjOW01wiJ3NJeGqxjioM">                  <div class="container h-100 ">
                      <div class="row h-100">
                          <div class="col-12 align-self-center mb-4">
                              <div class="row justify-content-center">
                                  <div class="col-11 col-sm-7 col-md-6 col-lg-5 col-xl-4">
                                      <h2 class="font-weight-normal mb-5 text-center text-warning"><b>Login</b></h2>
                                      ...
                                      <div class="row justify-content-center">
                                        <div class="col">
                                            <button type="submit" id="recaptcha" class="btn btn-warning rounded btn-block shadow">Login</button>
                                        </div>
                                      </div>

                                      <div class="row justify-content-center my-4">
                                        <div class="col text-center">
                                          <p class="text-white mb-1">Belum memiliki akun?</p>
                                          <a href="https://hamstercuan.com/user/register" class="text-white mb-3 pt-0">
                                            <b>Daftar</b>
                                          </a>
                                        </div>
                                    </div>
    ...
    <script src="https://hamstercuan.com/assets/global/js/jquery-3.6.0.min.js"></script>
    <script src="https://hamstercuan.com/assets/global/js/bootstrap.bundle.min.js"></script>


    <!--**** custom script start ****-->
    <!-- Required jquery and libraries -->
    <script src="https://hamstercuan.com/assets/templates/basic/assets/js/jquery-3.3.1.min.js"></script>
    <script src="https://hamstercuan.com/assets/templates/basic/assets/js/popper.min.js"></script>
    <script src="https://hamstercuan.com/assets/templates/basic/assets/vendor/bootstrap/js/bootstrap.min.js"></script>

    <!-- cookie js -->
    <script src="https://hamstercuan.com/assets/templates/basic/assets/js/jquery.cookie.js"></script>

    <!-- Swiper slider  js-->
    <script src="https://hamstercuan.com/assets/templates/basic/assets/vendor/swiper/js/swiper.min.js"></script>

    <!-- Swiper slider  js-->
    <script src="https://hamstercuan.com/assets/templates/basic/assets/vendor/swiper/js/swiper.min.js"></script>

    <!-- chart js-->
    <script src="https://hamstercuan.com/assets/templates/basic/assets/vendor/chartjs/Chart.bundle.min.js"></script>
    <script src="https://hamstercuan.com/assets/templates/basic/assets/vendor/chartjs/utils.js"></script>
    <script src="https://hamstercuan.com/assets/templates/basic/assets/vendor/chartjs/chart-js-data.js"></script>

    <!-- Customized jquery file  -->
    <script src="https://hamstercuan.com/assets/templates/basic/assets/js/main.js"></script>
    <script src="https://hamstercuan.com/assets/templates/basic/assets/js/color-scheme-demo.js"></script>

    <!-- PWA app service registration and works -->
    <script src="https://hamstercuan.com/assets/templates/basic/assets/js/pwa-services.js"></script>

    <!-- page level custom script -->
    <script src="https://hamstercuan.com/assets/templates/basic/assets/js/app.js"></script>
    <!--***** custom script end *****-->
    ...
    <script src="https://cdn.jsdelivr.net/npm/swiper@9/swiper-element-bundle.min.js"></script>
      ...
      $(document).ready(function () {
        ...
        $('#loginForm').submit(function (e) {
          ...
          $.ajax({
            type: "POST",
            url: "https://hamstercuan.com/user/login",
            data: formData,
            dataType: "json",
            contentType: false,
            processData: false,
            success: function (res) {
              ...
              if (res.cls == 'success') {
                window.location.href = "https://hamstercuan.com/user/dashboard"
              }
              $('.loginBtn').html('Login');
            }
          });
    ...
    <link rel="stylesheet" href="https://hamstercuan.com/assets/global/css/iziToast.min.css">
<script src="https://hamstercuan.com/assets/global/js/iziToast.min.js"></script>
    ...
    <script>
        ...
        (function($) {
            ...
            $(".langSel").on("change", function() {
                window.location.href = "https://hamstercuan.com/change/" + $(this).val();
            });
            ...
            $('.policy').on('click', function() {
                $.get('https://hamstercuan.com/cookie/accept', function(response) {
